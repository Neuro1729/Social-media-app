...
public class PostController {
    ...
    @GetMapping(path = "/api/posts/{id}/events", produces = MediaType.TEXT_EVENT_STREAM_VALUE)
    public SseEmitter postEvents(
            @PathVariable("id") UUID id,
            Authentication authentication
    ) {
        return postService.subscribeToEvents(id, optionalUserId(authentication));
    }
